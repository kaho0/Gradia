...
const AssignmentSection = () => {
  ...
  const fetchAssignments = async () => {
    try {
      ...
      setAssignments(response.data.assignments); // Adjust based on your API response
    } catch (error) {
  ...
  const handleAddAssignment = async (e) => {
    ...
    if (
      ...
      try {
        ...
        setAssignments([...assignments, response.data.assignment]); // Add the newly created assignment to the list
        setNewAssignment({
          title: "",
          description: "",
          grade: "",
